...
@router.get('/artists', response_description="Get all artists",
            response_model=PagedResponseSchema, status_code=status.HTTP_200_OK)
...
@router.get('/artist/{artist_id}', response_description="Get artist detail by id",
            response_model=ArtistDetail, status_code=status.HTTP_200_OK)
...
@router.post('/is_artists', response_description="Check if artist(s) exist", status_code=status.HTTP_200_OK)
...
@router.get('/discography/{artist_id}/{release_type_id}', response_description="Get albums",
            response_model=Albums, status_code=status.HTTP_200_OK)
...
@router.get('/album/{album_id}', response_description="Get album detail",
            response_model=AlbumDisplay, status_code=status.HTTP_200_OK)
...
@router.get('/artist_id/{album_id}', response_description="Get artist_id by album_id", status_code=status.HTTP_200_OK)
